...
const News = () => {
  return (
    <div className=" px-6 pt-6 pb-12">
      <h3 className="text-3xl font-bold text-gray-100 mb-8">University College News: <em>The Official School Magazine</em></h3>
      <ul className="news-items space-y-16 text-center md:text-left">
        {mockNews.map((news, index) => (
          <li key={index} className="flxcol text-gray-200 cursor-pointer md:space-x-4">
            ...
            <div className="">
              <h6 className="capitalize font-semibold text-lg mb-1 mt-6 md:text-xl">
                {news.title}
              </h6>
              <p className="text-sm text-gray-400 mt-2 md:text-base">
                {news.details}
              </p>
            </div>
          </li>
